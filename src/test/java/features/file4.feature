Feature: File 4 scenarios 

@Smoke
Scenario: File 4 Verify validation if place is being successfully added by using AddPlaceAPI
...
@Sanity
Scenario: File 4 Verify validation if Delete Place functionality is working  
