Feature: File 2 scenarios 

@Smoke
Scenario: File 2 Verify validation if place is being successfully added by using AddPlaceAPI
...
@Sanity
Scenario: File 2 Verify validation if Delete Place functionality is working  
