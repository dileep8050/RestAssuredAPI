...
@Reg
Scenario: File 3 Verify validation if place is being successfully added by using AddPlaceAPI
...
@Reg
Scenario: File 3 Verify validation if Delete Place functionality is working  
